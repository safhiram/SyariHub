...
<!-- Just an image -->
                                ...
                                <div class="container">
                                    <div class="c-hero--banner-full__content u-text-align__center--mobile u-text-align__center--tablet">
                                        <div class="row">
                                            ...
                                            <h1>SyariHub<br>MENTOR</h1>
                                                
                                                <p style="color:white;font-family:'Times New Rowman';font-size: 105%;">
                                                    <strong>Layanan belajar Al Quran.<br>Baik untuk tahsin secara privat maupun untuk menghafal Al Quran.</strong>
                                                </p>      
        ...
        <div class="container" id="tiga">
            <div id="tulisan">
            <b>CARA PAKAI SYARIHUB-MENTOR</b>
            </div>
                        ...
                        <div class="col-md-8 mr-auto ml-auto">
                            ...
                            <div class="card card-raised card-carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img class="d-block w-100" src="/img/step/mentor/1.png"
                                    alt="Slide Satu">
                                    </div>

                                    <div class="carousel-item">
                                    <img class="d-block w-100" src="/img/step/mentor/2.png"  alt="Slide Dua">
                                    </div>

                                    <div class="carousel-item">
                                    <img class="d-block w-100" src="/img/step/mentor/3.png" alt="Slide Tiga">
                                    </div>

                                    <div class="carousel-item">
                                    <img class="d-block w-100" src="/img/step/mentor/4.png"  alt="Slide Empat">
                                    </div>

                                    <div class="carousel-item">
                                    <img class="d-block w-100" src="/img/step/mentor/5.png"  alt="Slide Lima">
                                    </div>
                                </div>
